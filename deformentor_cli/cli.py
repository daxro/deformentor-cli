...
from deformentor_cli.api import (
    ...
    get_children, get_news_detail, switch_child,
)
...
def main():
    ...
    msg_parser = subparsers.add_parser("messages", help="Fetch messages for all children")
    ...
    cal_parser = subparsers.add_parser("calendar", help="Fetch a calendar event by ID")
